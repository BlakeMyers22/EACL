...
// Create and show platform-specific instructions
function showMetaMaskInstructions() {
    const env = getEnvironment();
    const instructionsDiv = document.getElementById('metamaskInstructions');
    
    if (env === 'mobile') {
        instructionsDiv.innerHTML = `
            <div class="instruction-content">
                <h3>MetaMask Setup Instructions</h3>
                <p>Please make sure you have MetaMask installed on your mobile device.</p>
                <p>1. Click the "CONNECT WALLET" button below.</p>
                <p>2. Once in MetaMask, go to the MetaMask browser and navigate back to this site.</p>
                <p>3. Click "CONNECT WALLET" again to complete the connection.</p>
                <a href="https://metamask.io/download/" target="_blank" class="instruction-link">Download MetaMask</a>
            </div>
        `;
        ...
        instructionsDiv.innerHTML = `
            <div class="instruction-content">
                <h3>MetaMask Setup Instructions</h3>
                <p>MetaMask is required to use this application. Please follow these steps:</p>
                <p>1. Install the MetaMask browser extension from the Chrome Web Store</p>
                <p>2. Create or import a wallet in MetaMask</p>
                <p>3. Return to this page and click "CONNECT WALLET"</p>
                <a href="https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn" 
                   target="_blank" class="instruction-link">Install MetaMask Extension</a>
            </div>
        `;
    } else {
...
async function handleSuccessfulConnection(address) {
    ...
    // Hide MetaMask instructions after successful connection
    document.getElementById('metamaskInstructions').style.display = 'none';
}
...
// Initial Setup
showPage('homePage');
showMetaMaskInstructions(); // Show MetaMask instructions on page load
